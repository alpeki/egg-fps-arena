 ...
 */
export function getBestRegion(pingResults) {
 ...
 */
export function getRecommendedRegion(userCountryCode) {
 ...
 */
export async function checkRegionHealth(regionId) {
